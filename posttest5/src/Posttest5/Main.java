...
public final  class Main {
    ...
    public static void main(boolean isMotorOnly) throws Exception {
      //  ArrayList<kendaraan> kendaraan = new ArrayList<>();
        ...
        while (true) {
            ...
            System.out.println("╔══════════════════════════════════════╗");
            System.out.println("             Dealer George        ");
            System.out.println("╔══════════════════════════════════════╗");
            System.out.println("╔══════════════════════════════════════╗");
            System.out.println("║              Menu                    ║");
            System.out.println("║  1. Tambah Data Motor                ║");
            System.out.println("║  2. Lihat Data Motor                 ║");
            System.out.println("║  3. Ubah Data  Motor                 ║");
            System.out.println("║  4. Hapus Data Motor                 ║");
            System.out.println("║  5. Tambah Data Suku Cadang          ║");
            System.out.println("║  6. Lihat Data Suku Cadang           ║");
            System.out.println("║  7. Ubah Data  Suku Cadang           ║");
            System.out.println("║  8. Hapus Data Suku Cadang           ║");
            ...
            switch (menu) {
                ...
                case 3:
                    ...
                    if (ubah <= dataMotor.size()) {
                        ...
                        dataMotor.get(ubah).getnama(Newsetnama);
